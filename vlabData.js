window.VLAB_DATA = {
    "intro_tools": {
        ...
        "viva": [
            {
                ...
                "a": "A Hub is a Layer-1 device that broadcasts incoming electrical signals to ALL ports, creating a single shared collision domain. A Switch is a Layer-2 device that reads MAC addresses and forwards frames ONLY to the destination port, providing dedicated bandwidth per port and zero collisions."
            },
            {
                "q": "Which OSI layer does a Router operate at, and how does it differ from a Switch?",
                "a": "A Router operates at Layer 3 (Network Layer) and routes packets between DIFFERENT networks using IP addresses. A Switch operates at Layer 2 (Data Link Layer) and forwards frames within the SAME local network using MAC addresses."
            },
            {
                "q": "What is the difference between a Straight-Through cable and a Crossover cable?",
                "a": "A Straight-Through cable uses identical T568B pinouts on both ends and connects DIFFERENT device types (e.g., PC to Switch). A Crossover cable swaps Pins 1&3 and Pins 2&6 and connects SIMILAR device types (e.g., PC to PC, Switch to Switch)."
            },
            {
                "q": "What is a MAC address, how many bits does it contain, and how is it formatted?",
                "a": "A MAC (Media Access Control) address is a permanent 48-bit (6-byte) physical hardware address burned into a NIC. It is formatted as 12 hexadecimal digits grouped in 6 pairs (e.g., 00:1A:2B:3C:4D:5E), where the first 24 bits identify the manufacturer (OUI)."
            },
            {
                "q": "What do the Link and Activity LEDs on a switch or NIC port indicate?",
                "a": "A solid Green Link LED indicates physical layer continuity (carrier detect). A flashing Green Activity LED indicates active data frame transmission and reception."
            },
            {
                "q": "What is the difference between Single-Mode and Multi-Mode Fiber Optic cables?",
                "a": "Single-Mode Fiber has a very thin core (~9 microns), uses laser light, and transmits data over long distances (up to 40 km) with minimal dispersion. Multi-Mode Fiber has a thicker core (~50-62.5 microns), uses LED light, and is designed for shorter distances (up to 550 meters) inside buildings."
            }
        ],
        ...
        "references": [
            {
                "title": "Computer Networking: A Top-Down Approach (8th Edition) by Kurose & Ross",
                "link": "https://www.pearson.com"
            },
            {
                "title": "Data Communications and Networking (5th Edition) by Behrouz A. Forouzan",
                "link": "https://www.mheducation.com"
            },
            {
                "title": "IEEE 802.3 Ethernet Working Group Standards",
            ...
            {
                "title": "Cisco Enterprise Networking & Cabling Guide",
    ...
    "net_commands": {
        ...
        "intro": {
            ...
            "applications": [
                ...
                "Enterprise Helpdesk Troubleshooting",
                "Server Socket Audit"
            ],
        ...
        "viva": [
            {
                "q": "What ICMP message type is sent by ping, and what is the expected response?",
                "a": "Ping sends an ICMP Type 8 (Echo Request) message. The destination host responds with an ICMP Type 0 (Echo Reply) message."
            },
            {
                "q": "How does traceroute discover intermediate routers along a network path?",
                "a": "Traceroute sends IP packets with sequentially incrementing Time-To-Live (TTL = 1, 2, 3...). Each intermediate router decrements TTL by 1. When TTL reaches 0, the router drops the packet and returns an ICMP Time Exceeded (Type 11) message, revealing its IP."
            },
            {
                "q": "What is the purpose of the ARP cache and why is it needed?",
                "a": "The ARP cache stores dynamic mappings between 32-bit IPv4 addresses and 48-bit physical MAC addresses. It prevents devices from having to broadcast ARP requests for every single packet transmitted."
            },
            {
                "q": "What does `netstat -an` display?",
                "a": "It displays all active TCP and UDP socket connections and listening ports in numeric IP:Port format."
            },
            {
                "q": "What is the difference between `ipconfig` and `ipconfig /all`?",
                "a": "`ipconfig` displays basic IPv4, Subnet Mask, and Gateway info. `ipconfig /all` displays detailed info including Physical MAC address, DHCP lease timestamps, and DNS server IPs."
            },
            {
                "q": "What Cisco IOS command displays the router's Layer 3 routing table?",
                "a": "`show ip route` displays the active IP routing table showing Connected (C), Static (S), RIP (R), and OSPF (O) routes."
            }
        ],
        ...
        "references": [
            {
                "title": "RFC 792 - Internet Control Message Protocol (ICMP Specification)",
                "link": "https://datatracker.ietf.org/doc/html/rfc792"
            },
            {
                "title": "RFC 826 - An Ethernet Address Resolution Protocol (ARP Specification)",
                "link": "https://datatracker.ietf.org/doc/html/rfc826"
            },
            {
            ...
            {
                "title": "Cisco IOS Command Reference - Verification Commands",
                "link": "https://www.cisco.com"
            }
        ],
        "simType": "cli"
    ...
    "topologies": {
        ...
        "intro": {
            ...
            "applications": [
                "Enterprise Office LANs (Star Topology)",
                "ISP Core Backbones (Mesh Topology)",
                "Campus Infrastructure (Tree Architecture)",
                "Industrial Control Loops (Ring Topology)",
                "Multi-Cloud Enterprises (Hybrid Topology)"
            ],
        ...
        "tools": [
            {
                "name": "50-Ohm BNC Bus Terminator",
                "layer": "Layer 1 Physical",
                "ports": "BNC Male Connector",
                "usage": "Absorbs RF signal reflections at coaxial backbone ends",
                "statusLED": "Passive Resistance 50Ω"
            },
            {
                "name": "Cisco Catalyst 2960 24-Port L2 Star Switch",
                "layer": "Layer 2 Switching",
                "ports": "24x 10/100 Mbps + 2x GbE Uplinks",
                "usage": "Central node for Star Topology LANs",
                "statusLED": "Green (Link UP / Active)"
            },
            {
                "name": "Token-Ring Multistation Access Unit (MAU)",
                "layer": "Layer 2 Data Link",
                "ports": "8x Ring Ports + Ring-In/Ring-Out",
                "usage": "Relays token passing loop in Ring Topologies",
                "statusLED": "Relay Active LED"
            },
            {
                "name": "Cisco ASR 9000 Mesh Core Router Matrix",
                "layer": "Layer 3 Routing",
                "ports": "100 GbE / 400 GbE Dense Linecards",
                "usage": "High-availability ISP Full Mesh backbone router",
                "statusLED": "Redundant Power / Active"
            },
            {
                "name": "3-Tier Hierarchical Switch Stack",
                "layer": "Layer 2 / Layer 3",
                "ports": "Core, Distribution, Access Stack",
                "usage": "Enterprise Tree Topology distribution tier",
                "statusLED": "Stack Master Green"
            },
            {
                "name": "Hybrid Enterprise WAN Gateway",
                "layer": "Layer 3 Multi-Protocol",
                "ports": "Fiber, Serial, Ethernet Multi-FX",
                "usage": "Interconnects Star LANs to ISP Mesh WAN",
                "statusLED": "WAN Link Active"
            }
        ],
        "procedure": [
        ...
        "troubleshooting": {
            ...
            "hints": [
                "Check if 50-ohm BNC cable terminators are missing at either end of the backbone cable."
            ],
        ...
        "viva": [
            {
                "q": "What is the key difference between Physical Topology and Logical Topology?",
                "a": "Physical topology is the actual geometric arrangement of physical cables and hardware devices. Logical topology is the path data frames take to travel across the network."
            },
            {
                "q": "How many network ports does each computer require in a Full Mesh network of N nodes?",
                "a": "Each computer requires P = N - 1 network interface ports."
            },
            {
                "q": "What happens if one workstation cable breaks in a Star Topology?",
                "a": "Only that specific workstation loses network connectivity. All other workstations connected to the switch continue communicating normally."
            },
            {
                "q": "What happens if the backbone cable breaks in a Bus Topology?",
                "a": "The entire network fails completely because signal reflection occurs at the break point and the bus becomes un-terminated."
            },
            {
                "q": "Why do ISPs and Data Centers use Mesh Topology despite its high cost?",
                "a": "Because Mesh Topology provides redundant communication paths. If a fiber cable is cut, traffic automatically fails over to alternate paths without any service downtime."
            },
            {
                "q": "What is a Hybrid Topology? Give an example.",
                "a": "A Hybrid Topology combines two or more different topologies (e.g. Star-Bus, Star-Ring, Mesh-Tree). An example is a university campus using Star topology in computer labs connected via a Tree structure to a Mesh data center."
            }
        ],
        ...
        "references": [
            {
                "title": "IEEE 802.3 Ethernet Standards Overview",
                "link": "https://standards.ieee.org"
            },
            {
                "title": "Cisco Campus Network Architecture & Topology Design Guide",
                "link": "https://www.cisco.com"
            },
            {
                "title": "RFC 791 - Internet Protocol Specification",
        ...
        "evaluations": [
            {
                ...
                "explanation": "Star topology connects all nodes individually to a central switch or hub."
            },
            {
                "type": "pre",
                "question": "In a fully connected Mesh topology with N nodes, how many physical links are required?",
                "options": [
                    "N - 1",
                    "N",
                    "N*(N - 1)/2",
                ...
                "answer": "N*(N - 1)/2",
                "explanation": "Full mesh requires N*(N-1)/2 physical channels to connect every node to every other node."
            },
            {
                "type": "pre",
                "question": "What happens when the main backbone cable breaks in a linear Bus topology?",
                "options": [
                    "Only one PC drops offline",
                    "The entire network communication collapses",
                    "The network automatically switches to wireless",
                    "No impact on communication"
                ],
                "answer": "The entire network communication collapses",
                "explanation": "A break in a bus backbone cable causes signal reflections and halts all communication."
            },
            {
                "type": "pre",
                "question": "Which topology provides the highest redundancy and fault tolerance?",
                "options": [
                    "Bus",
                    "Star",
                    "Ring",
                ...
                "answer": "Full Mesh",
                "explanation": "Full mesh provides redundant dedicated paths between every pair of devices."
            },
            {
                "type": "pre",
                "question": "What device terminates signals at both ends of a Bus topology cable?",
                "options": [
                    "Switch",
                    "Router",
                    "Terminator (50-ohm resistor)",
                    "Bridge"
                ],
                "answer": "Terminator (50-ohm resistor)",
                "explanation": "Terminators absorb electrical signals at cable ends to prevent signal reflection."
            },
            {
                "type": "post",
                "question": "Which topology is most commonly deployed in modern Ethernet LANs?",
                "options": [
                    "Bus",
                    "Star",
                    "Ring",
                ...
                "answer": "Star",
                "explanation": "Modern LANs use Star topology with twisted-pair cables connected to central switches."
            },
            {
                "type": "post",
                "question": "What is a major advantage of Star topology over Bus topology?",
                "options": [
                    "Requires less cabling",
                    "Failure of a single node cable does not disable the entire network",
                    "Does not require a central switch",
                    "Lower hardware cost"
                ],
                "answer": "Failure of a single node cable does not disable the entire network",
                "explanation": "If one PC cable fails in a Star topology, only that PC goes offline while the rest of the network operates normally."
            },
            {
                "type": "post",
                "question": "In a Ring topology, how does data travel across nodes?",
                "options": [
                    "In both directions simultaneously",
                    "In a single direction token-passing loop",
                    "Random broadcast",
                    "Direct point-to-point without intermediate nodes"
                ],
                "answer": "In a single direction token-passing loop",
                "explanation": "Data packets travel in a single direction around the ring passed from node to node."
            },
            {
                "type": "post",
                "question": "What is a Hybrid topology?",
                "options": [
                    "A topology using only wireless links",
                    "A combination of two or more distinct basic topologies (e.g. Star-Bus or Star-Ring)",
                    "A network with only 2 PCs",
                    "A network running IPv6 only"
                ],
                "answer": "A combination of two or more distinct basic topologies (e.g. Star-Bus or Star-Ring)",
                "explanation": "Hybrid topology combines multiple structural topologies to leverage their benefits."
            },
            {
                "type": "post",
                "question": "Which topology suffers from single-point-of-failure at the central switch?",
                "options": [
                    "Bus",
                    "Star",
                    "Mesh",
                ...
                "answer": "Star",
                "explanation": "If the central switch in a Star topology fails, all connected devices lose connectivity."
            },
            {
                "type": "post",
                "question": "How many links are required for a 6-node Full Mesh network?",
                "options": [
                    "6",
                    "12",
                    "15",
                ...
                "answer": "15",
                "explanation": "Formula: N*(N-1)/2 = 6*5/2 = 15 links."
            },
            {
                "type": "post",
                "question": "What type of cable was historically used in Thinnet Bus topologies?",
                "options": [
                    "Cat6 RJ45",
                ...
                "explanation": "Thinnet 10Base2 bus networks used RG-58 coaxial cabling with BNC connectors."
            },
            {
                "type": "post",
                "question": "Which topology requires token passing to prevent collisions?",
                "options": [
                    "Star",
                    "Bus",
                    "Ring",
                ...
                "answer": "Ring",
                "explanation": "Token Ring networks use a 3-byte token passed around the ring to control media access."
            },
            {
                "type": "post",
                "question": "What is Tree topology?",
                "options": [
                    "A hierarchical combination of multiple Star topologies connected to a root bus",
                    "A circular loop",
                    "A mesh network",
                    "A single cable bus"
                ],
                "answer": "A hierarchical combination of multiple Star topologies connected to a root bus",
                "explanation": "Tree topology arranges nodes hierarchically in branches connected to main switches."
            },
            {
                "type": "post",
                "question": "Which topology is most expensive and complex to install for 100 devices?",
                "options": [
                    "Bus",
                    "Star",
                    "Full Mesh",
                ...
                "answer": "Full Mesh",
                "explanation": "Full mesh for 100 devices requires 4,950 cables, making it cost-prohibitive."
            }
        ]
    },
    "ip_class": {
    ...
    "lan_cables": {
        ...
        "troubleshooting": {
            ...
            "hints": [
                "Verify if interconnect port between Switch 1 and Switch 2 is set to Trunk mode.",
        ...
        "viva": [
            {
                "q": "What is the purpose of IEEE 802.1Q tagging?",
                "a": "It inserts a 4-byte VLAN tag into Ethernet headers so trunks can multiplex traffic for multiple VLANs across a single physical link."
            },
            {
                "q": "What is a Native VLAN?",
                "a": "An un-tagged VLAN on an 802.1Q trunk port (defaults to VLAN 1)."
            }
        ],
        "assignment": "Configure VLAN 10 (Engineering) and VLAN 20 (Marketing) across 2 Cisco switches. Verify traffic separation.",
        "references": [
            {
                "title": "IEEE 802.1Q Standard",
                "link": "https://standards.ieee.org"
            }
        ],
        "simType": "cli",
        "evaluations": [
            {
                "type": "pre",
                "question": "Which T568 color standard pinout order begins with White-Orange, Orange, White-Green, Blue...?",
                "options": [
                    "T568A",
                    "T568B",
                    "USOC",
                ...
                "answer": "T568B",
                "explanation": "T568B pinout order is 1:W-Org, 2:Org, 3:W-Grn, 4:Blu, 5:W-Blu, 6:Grn, 7:W-Brn, 8:Brn."
            },
            {
                "type": "pre",
                "question": "What cable type is used to connect two like network devices directly (e.g. PC to PC)?",
                "options": [
                    "Straight-Through Cable",
                    "Crossover Cable",
                    "Rollover Cable",
                ...
                "explanation": "Crossover cables swap Tx and Rx pins, enabling direct communication between identical MDI devices."
            },
            {
                "type": "pre",
                "question": "What connector type is standard for Ethernet twisted-pair copper cabling?",
                "options": [
                    "RJ11",
                    "RJ45",
                    "BNC",
                ...
                "answer": "RJ45",
                "explanation": "RJ45 (Registered Jack 45) is the 8-position, 8-contact connector used for Ethernet."
            },
            {
                "type": "pre",
                "question": "What cable type is used to connect a PC Ethernet port to an Ethernet switch port?",
                "options": [
                    "Crossover Cable",
                    "Straight-Through Cable",
                    "Console Cable",
                ...
                "explanation": "Straight-Through cables connect MDI (PC/Router) to MDI-X (Switch/Hub) devices."
            },
            {
                "type": "pre",
                "question": "What feature automatically detects required cable pinouts on modern Ethernet switches?",
                "options": [
                    "Auto-MDIX",
                    "Auto-Duplex",
                    "Auto-Negotiation",
                ...
                "answer": "Auto-MDIX",
                "explanation": "Auto-MDIX automatically detects cable type (straight vs crossover) and configures ports."
            },
            {
                "type": "post",
                "question": "Which pins are used for transmitting (Tx) and receiving (Rx) data in 100BASE-TX Fast Ethernet?",
                "options": [
                    "Pins 1, 2, 3, 6",
                    "Pins 1, 2, 4, 5",
                    "Pins 4, 5, 7, 8",
                ...
                "answer": "Pins 1, 2, 3, 6",
                "explanation": "100BASE-TX Fast Ethernet uses pair 1-2 for Tx and pair 3-6 for Rx."
            },
            {
                "type": "post",
                "question": "How many wire pairs are inside a standard Cat6 UTP cable?",
                "options": [
                    "2 pairs",
                    "4 pairs",
                    "6 pairs",
                ...
                "answer": "4 pairs",
                "explanation": "Cat5e/Cat6 UTP cables contain 4 color-coded twisted copper pairs (8 wires)."
            },
            {
                "type": "post",
                "question": "What tool is used to attach an RJ45 modular plug onto a stripped UTP cable?",
                "options": [
                    "Wire Stripper",
                    "Crimping Tool",
                    "Punch Down Tool",
                ...
                "explanation": "A crimping tool squeezes RJ45 metallic contacts into copper conductors and clamps the cable jacket."
            },
            {
                "type": "post",
                "question": "What T568 standard pinout order begins with White-Green, Green, White-Orange, Blue...?",
                "options": [
                    "T568A",
                    "T568B",
                    "Cat5",
                ...
                "answer": "T568A",
                "explanation": "T568A begins with White-Green and Green on pins 1 and 2."
            },
            {
                "type": "post",
                "question": "What type of cable has T568A on one end and T568B on the other end?",
                "options": [
                    "Straight-Through Cable",
                    "Crossover Cable",
                ...
                "answer": "Crossover Cable",
                "explanation": "A Crossover cable terminates with T568A on end 1 and T568B on end 2."
            },
            {
                "type": "post",
                "question": "What tool verifies pin continuity and wire mapping across all 8 pins of an Ethernet cable?",
                "options": [
                ...
                "answer": "Cable Tester / Continuity Tester",
                "explanation": "A cable tester lights LEDs 1 through 8 sequentially to verify wire mapping."
            },
            {
                "type": "post",
                "question": "What maximum distance is supported for standard Cat6 UTP Ethernet runs without repeaters?",
                "options": [
                    "50 meters",
                    "100 meters",
                    "250 meters",
                ...
                "answer": "100 meters",
                "explanation": "IEEE 802.3 specifies a maximum copper channel distance of 100 meters (90m solid + 10m patch)."
            },
            {
                "type": "post",
                "question": "What is the function of twisting wire pairs inside UTP cables?",
                "options": [
                ...
                "answer": "Reduces Electromagnetic Interference (EMI) and Crosstalk",
                "explanation": "Differential signaling over twisted pairs cancels out crosstalk and external noise."
            },
            {
                "type": "post",
                "question": "What cable type is used to connect a PC COM port to a Cisco router console port?",
                "options": [
                    "Straight-Through",
                    "Crossover",
                    "Console Rollover Cable (RJ45 to DB9)",
                    "Fiber Optic"
                ],
                "answer": "Console Rollover Cable (RJ45 to DB9)",
                "explanation": "Console rollover cables pin out pin 1 to pin 8, pin 2 to pin 7, etc., for out-of-band management."
            },
            {
                "type": "post",
                "question": "What category of twisted-pair cable supports 10 Gigabit Ethernet up to 55 meters?",
                "options": [
                    "Cat3",
                    "Cat5",
                    "Cat6",
                ...
                "answer": "Cat6",
                "explanation": "Cat6 supports 10GBASE-T up to 55 meters (Cat6A supports 10GBASE-T to 100 meters)."
            }
        ]
    },
    "subnetting": {
